...
public class TaskDialog extends AppCompatActivity implements View.OnClickListener{
    ...
    private ImageView notifOn,notifOff,timeOn,timeOff,dateOn,dateOff;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateOn= (ImageView) findViewById(R.id.addTaskDateOnId);
        dateOff= (ImageView) findViewById(R.id.addTaskDateOffId);
        ...
        dateOn.setOnClickListener(this);
        dateOff.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        else if(view.getId()==R.id.addTaskDateOnId)
        {
            dateOn.setVisibility(View.GONE);
            dateOff.setVisibility(View.VISIBLE);
            date.setText("Pinned Tasks");
           // notifState.setText("Off");
        }

        else if(view.getId()==R.id.addTaskDateOffId)
        {
            dateOff.setVisibility(View.GONE);
            dateOn.setVisibility(View.VISIBLE);
            date.setText(ExtraFunction.setDate(getApplicationContext(),days,months,years));
    ...
    private void onSaveClick()
    {
        ...
        if(date.getText().equals("Pinned Tasks")){
            days=-1;
            months=-1;
            years=-1;
        }
        ...
        if (nameText.equals("")) {
            ...
            if(section.equals("Edit Task"))
            {
                ...
                rowNo = databaseHelper.saveData(nameText, descriptionText, priorityText, hour, minute, days, months, years, 0,notifState1);
